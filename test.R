...
read_tsv('y16_d  1_neu.tsv')
View(datae)
data <- read_tsv('y16_d  1_neu.tsv')
View(data)
summary(data)
plot(datan,dt,n1)
...
plot(datafilter$l,datafilter$b,col=colr[datafilter$n1])
plot(datafilter$l,datafilter$b,col=colr[datafilter$n1+1])
plot(datafilter$l,datafilter$b,cex=datafilter$n1,col=colr[datafilter$n1+0])
